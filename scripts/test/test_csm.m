function [tprs, fprs, tsvs, ms] = test_csm(data_1, data_0, test_opt, threshs)
...
for t = 1:n_thresh
    ...
    test_stat_val_0 = [];
    for s1 = 1:n_data_1
        [ts1s, tsv1s] = test_stat_csm(data_1{s1}, test_opt);
    ...
    for s0 = 1:n_data_0
        [ts0s, tsv0s] = test_stat_csm(data_0{s0}, test_opt);
